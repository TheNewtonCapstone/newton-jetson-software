...
struct Imu{
  ...
  inline Vector3 quat_to_rpy(const double q, const double x, const double y, const double z){
    Vector3 rpy;
  ...
  inline Vector3 quat_to_proj_gravity(const double q, const double x, const double y, const double z){
